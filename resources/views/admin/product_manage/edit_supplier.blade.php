            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Đổi sản phẩm</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-2">
                            <form action="">
                                ...
                                <div class="form-group">
                                    <label for="">Địa chỉ cung cấp </label>
                                    <input type="text" name="" class="form-control" placeholder="Nhập địa chỉ cung cấp">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="" id="" rows="8" placeholder="Nhập mô tả"></textarea>
                                </div>
